...
<?php include 'carte.php';?>
            <?php include 'coeur.php';?>
             ...
             <script src="../js/bebe3.js"></script>
             <script src="../js/script.js"></script>

             <nav class="pagination pagination-container">
                <ul>
                    <li>
                        <a href="produit_bebe2.php" class="link-arrow" title="Voir précédent">
                    ...
                    <li><a href="produit_bebe3.php" style="background-color: gray;">3</a></li>
                </ul>
            </nav>
