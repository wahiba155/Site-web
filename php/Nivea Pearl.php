...
<head>
    ...
    <!--==Title============================-->
    <title>Deodoreant NIVEA 48h</title>
    <!--==CSS==============================-->
    ...
    <div class="product-details">
        ...
        <div class="swiper mySwiper">
            ...
            <div class="swiper-slide">
                <img src="../site/body/deo.jpg" />
            </div>
            <!--**2******-->
            <div class="swiper-slide">
                <img src="../site/body/deo2.jpg" />
            </div>
            <!--**3******-->
        ...
        <div class="product-text">
            ...
            <h3>NIVEA Déodorant Femme </h3>
            <span class="product-price">60MAD</span>
            <p>NIVEA Déodorant L'anti-transpirant NIVEA Pearl & Beauty pour femme est une formule innovante 
                qui embellit vos aisselles et offre à votre peau une protection fiable de 48H
                Formule douce avec protection contre la transpiration et infusion d’extraits de perles, 
                l'anti-transpirant NIVEA Pearl & Beauty équilibre votre couleur de peau et lui laisse 
                une fraîcheur durable tout en tenant à distance la transpiration et les odeurs corporelles. 
            </p>
            <!--size-->
            <!--btn-->
