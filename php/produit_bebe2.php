...
<?php include 'carte.php';?>
            <?php include 'coeur.php';?>
             ...
             <script src="../js/bebe2.js"></script>
             <script src="../js/script.js"></script>

    <nav class="pagination pagination-container">
        <ul>
            <li>
                <a href="produit_bebe.php" class="link-arrow" title="Voir précédent">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8"/>
                      </svg> <!-- Icône de flèche vers la gauche -->
                </a>
            </li>
            <li><a href="produit_bebe.php">1</a></li>
            <li><a href="produit_bebe2.php" style="background-color: gray;">2</a></li>
            <li><a href="produit_bebe3.php">3</a></li>
            <li><a href="produit_bebe3.php" class="link-arrow" title="Voir plus">
