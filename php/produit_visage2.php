...
<?php include 'carte.php';?>
            <?php include 'coeur.php';?>
             ...
             <script src="../js/visage2.js"></script>
             <script src="../js/script.js"></script>

    <nav class="pagination pagination-container">
        <ul>
            <li>
                <a href="produit_visage.php" class="link-arrow" title="Voir précédent">
            ...
            <li><a href="produit_visage2.php" style="background-color: gray;">2</a></li>
            <li><a href="produit_visage3.php">3</a></li>
            <li><a href="produit_visage3.php" class="link-arrow" title="Voir plus">
