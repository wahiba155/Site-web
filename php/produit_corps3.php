...
<?php include 'carte.php';?>
            <?php include 'coeur.php';?>
             ...
             <script src="../js/corps3.js"></script>
             <script src="../js/script.js"></script>

             <nav class="pagination pagination-container">
                <ul>
                    <li>
                        <a href="produit_corps2.php" class="link-arrow" title="Voir précédent">
                    ...
                    <li><a href="produit_corps3.php" style="background-color: gray;">3</a></li>
                </ul>
            </nav>
