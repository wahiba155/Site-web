...
<head>
    ...
    <!--==Title============================-->
    <title>CELLULAR EXPERT LIFT SÉRUM EFFET LIFTANT 3 ZONES</title>
    <!--==CSS==============================-->
    ...
    <div class="product-details">
        ...
        <div class="swiper mySwiper">
            ...
            <div class="swiper-slide">
                <img src="../site/visage/sn.jpg" />
            </div>
            <!--**2******-->
            <div class="swiper-slide">
                <img src="../site/visage/sn2.jpg" />
            </div>
            <!--**3******-->
            <div class="swiper-slide">
                <img src="../site/visage/sn3.jpg" />
            </div>
            </div>
...
{
  id: 5,
  image: '../site/visage/nevia.png',
  title: 'Sérum',
  price: 140,
  desc:'Sérum anti-âge pour le visage Healthy Renew 1 oz, sérum alternatif au rétinol pour le visage',
  quantity: 0,
}
